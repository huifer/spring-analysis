...
我们来看一下最后的执行结果 ![image-20210126135528662](/docs/ch-12/images/image-20210126135528662.png)
...
- `resolveValue(pv.getValue())` 执行后
  ...
  ![image-20210127113313399](/docs/ch-12/images/image-20210127113313399.png)
